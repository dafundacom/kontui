...
import type { ScaleProps } from "./scale-context"

const generateGetScaleProps = <P,>(
  props: P & ScaleProps,
): GetScalePropsFunction => {
...
const generateGetAllScaleProps = <P,>(
  props: P & ScaleProps,
): GetAllScalePropsFunction => {
...
export { generateGetScaleProps, generateGetAllScaleProps }
