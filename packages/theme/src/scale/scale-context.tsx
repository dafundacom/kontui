...
const ScaleContext = React.createContext<ScaleConfig>(defaultContext)

const useScale = (): ScaleConfig => React.useContext<ScaleConfig>(ScaleContext)
...
export { ScalePropKeys, ScaleContext, useScale }
