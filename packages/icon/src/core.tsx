...
export const QuestionCircleIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ color = "currentColor", width, height, ...props }, ref) => {
    return (
      <svg
        ref={ref}
    ...
    return (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.262626-2.694-1.262626-3.464 0L3.34 16c-.77 1.262626.192 3 1.732 3z"
        />
      </svg>
    )
  },
